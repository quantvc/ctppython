...
from pyctp.generate.generate_struct import Parse
...
def generate_hpp():
    ...
    生成头文件 struct.h 结构
    """
    ctp_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    type_file = os.path.join(ctp_path, "ctp/ThostFtdcUserApiDataType.h")
    struct_file = os.path.join(ctp_path, "ctp/ThostFtdcUserApiStruct.h")
